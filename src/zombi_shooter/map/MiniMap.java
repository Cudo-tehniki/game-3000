...
public class MiniMap {
    ...
    private final int MINI_MAP_MARGE = 20;
    private final Color MINI_MAP_BACKGROUND = new Color(0, 0, 0, 90);
    ...
    public void draw(Graphics2D g2d, List<Zomboid> zomb, List<Chest> chests, Player player, BossZombie boss) {
        int x = windowWidth - MINI_MAP_MARGE - MINI_MAP_SIZE;
        int y = MINI_MAP_SIZE + MINI_MAP_MARGE;
    ...
    public void drawRoads(Graphics2D g2d, int miniMapX, int miniMapY, double scaleX, double scaleY) {
        ...
        for (var road : mapGenerator.getRoads()) {
            ...
            if (road.width > road.height) {
                g2d.drawLine(x1, y1 + road.height / 2, x2, road.width / 2);
            } else {
